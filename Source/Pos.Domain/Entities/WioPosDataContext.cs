...
public partial class WioPosDataContext : DbContext
{
    public WioPosDataContext()
    {
    }

    public WioPosDataContext(DbContextOptions<WioPosDataContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=WIO.POS.DATA;Trusted_Connection=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BranchOffice>(entity =>
        {
            entity.HasKey(e => e.BranchOfficeId).HasName("PK__BranchOf__27247FF90BA471C7");
        ...
        {
            entity.HasKey(e => e.BusinessId).HasName("PK__Business__F1EAA36E8F54771D");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0BF627B203");
        ...
        {
            entity.HasKey(e => e.ClientId).HasName("PK__Clients__E67E1A24E66BDB00");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED2FC29F26");
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__District__85FDA4C6BFD9EF8C");
        ...
        {
            entity.HasKey(e => e.DocumentTypeId).HasName("PK__Document__DBA390E1AA9B5C54");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menus__C99ED23018599763");
        ...
        {
            entity.HasKey(e => e.MenuRolId).HasName("PK__MenuRole__6640AD0C603109F8");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CDD2F4DBDD");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687D2F9580AB");
        ...
        {
            entity.HasKey(e => e.ProvinceId).HasName("PK__Province__FD0A6F83ABF8B757");
        ...
        {
            entity.HasKey(e => e.PurcharseId).HasName("PK__Purchars__A98C674B31D18D48");
        ...
        {
            entity.HasKey(e => e.PurcharseDetailId).HasName("PK__Purchars__7353248B6E485790");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A31E51C19");
        ...
        {
            entity.HasKey(e => e.SaleId).HasName("PK__Sales__1EE3C3FF1F5D9581");
        ...
        {
            entity.HasKey(e => e.SaleDetailId).HasName("PK__SaleDeta__70DB14FE1144C876");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C6AFEB1E6");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A35AB58EAD6");
        ...
        {
            entity.HasKey(e => e.UserBranchOfficeId).HasName("PK__UsersBra__7D1E804AA18B017E");
